...
def main():
    ...
    # Remove rows with ethnie having numeric values
    # df['ethnie_numeric'] = pd.to_numeric(df['ETHNIE'], errors='coerce')
    # df = df[df['ethnie_numeric'].isna()]
    # df = df.drop(columns='ethnie_numeric')
